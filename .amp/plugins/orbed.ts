...
import controls from '../../tests/controls.orbed.ts'
import portals from '../../tests/portals.orbed.ts'
import resources from '../../tests/resources.orbed.ts'

const includeNegativeControls = process.env.ORBED_INCLUDE_NEGATIVE_CONTROLS === '1'

export const description = 'Run this project’s portal tests with Amp agents and browser-backed assertions.'
export default orbed([...tests, ...portals, ...resources, ...(includeNegativeControls ? controls : [])], {
  allowShell: true,
